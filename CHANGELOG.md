...
- SQLite storage layer: LynxStorage class with store_metrics / query_recent, WAL-mode schema with indexed timestamp queries; integrated into daemon via config callback; 4 unit tests for store, query, limit, and isolation
